        ...
        {({ open }) => (
          <div className="relative flex flex-col">
            ...
            >
              <Menu.Items
                className={classNames(
                  "absolute  mt-2 w-fit divide-y pb-2 pt-2 divide-gray-100 rounded-xl bg-white shadow-xl border border-solid border-gray-200  z-50 ",
                  props.originString
                    ? props.originString
                    : "origin-bottom-left top-0 right-0"
                )}
              >
